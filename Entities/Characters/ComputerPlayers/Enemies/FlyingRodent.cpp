#include "FlyingRodent.h"
#include "../../GameMap.h"
#include "../../../../Factories/ItemFactory.h"

FlyingRodent::FlyingRodent(float x, float y) {
    movement.x = 0;
    movement.y = 0;
    xPosition = x;
    yPosition = y;
...
FlyingRodent::FlyingRodent(float x, float y, GameMap* gamemap) {
    movement.x = 0;
    movement.y = 0;
    xPosition = x;
    yPosition = y;
...
void FlyingRodent::generateItem() {
...
void FlyingRodent::setMoving(bool move) {
    moving = move;
}

bool FlyingRodent::isMoving() {
    return moving;
}

void FlyingRodent::MoveLeft() {
...
void FlyingRodent::startAnimation() {
...
void FlyingRodent::Update(sf::RenderWindow* Window) {
...
void FlyingRodent::resetDistance() {
    sf::FloatRect bounds = getSprite()->getGlobalBounds();
    distanceX = 0;
    distanceY = 0;
...
void FlyingRodent::setup() {
    ...
    walkingAnimationRight.addFrame(sf::IntRect(224, 192, 32, 32));
    walkingAnimationRight.addFrame(sf::IntRect(224, 224, 32, 32));

    walkingAnimationLeft.setSpriteSheet(texture);
    walkingAnimationLeft.addFrame(sf::IntRect(224, 128, 32, 32));
    walkingAnimationLeft.addFrame(sf::IntRect(224, 160, 32, 32));

    walkingAnimationUp.setSpriteSheet(texture);
    walkingAnimationUp.addFrame(sf::IntRect(192, 128, 32, 32));
    walkingAnimationUp.addFrame(sf::IntRect(192, 160, 32, 32));

    walkingAnimationDown.setSpriteSheet(texture);
    walkingAnimationDown.addFrame(sf::IntRect(192, 192, 32, 32));
    walkingAnimationDown.addFrame(sf::IntRect(192, 224, 32, 32));
