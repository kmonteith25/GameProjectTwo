...
void Block::setup() {
    ...
    walkingAnimationRight.addFrame(sf::IntRect(32, 960, 32, 32));
    walkingAnimationRight.addFrame(sf::IntRect(32, 992, 32, 32));

    walkingAnimationLeft.setSpriteSheet(texture);
    walkingAnimationLeft.addFrame(sf::IntRect(32, 896, 32, 32));
    walkingAnimationLeft.addFrame(sf::IntRect(32, 928, 32, 32));

    walkingAnimationUp.setSpriteSheet(texture);
    walkingAnimationUp.addFrame(sf::IntRect(0, 896, 32, 32));
    walkingAnimationUp.addFrame(sf::IntRect(0, 928, 32, 32));

    walkingAnimationDown.setSpriteSheet(texture);
    walkingAnimationDown.addFrame(sf::IntRect(0, 960, 32, 32));
    walkingAnimationDown.addFrame(sf::IntRect(0, 992, 32, 32));
